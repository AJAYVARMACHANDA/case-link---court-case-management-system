...
from ccms.views import login, lawyerregistration, clientregistration, getlawyers, activateAccount, logout, postCase, \
    ...
    deleteAppointment, updateappointment, updateappointmentaction, acceptorrejectcase, searchlawyers,download_file
...
urlpatterns = [
    ...
    path('searchlawyeraction/',searchlawyers,name="view"),
